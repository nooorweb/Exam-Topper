...
export const DEFAULT_VOCAB: VocabWord[] = [
  ...
  },
  {
    ...
    urduMeaning: "انحراف / بے راہ روی (Inhiraf / Be-rah-ravi)",
    synonyms: ["anomaly", "deviation", "divergence", "abnormality"],
    antonyms: ["normality", "conformity", "regularity", "standard"],
    example: "The leakage of the screening test paper was described as a temporary aberration in ETEA's history.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    id: "vocab-10",
    word: "Abnegation",
    meaning: "The solemn rejection or renunciation of a belief, doctrine, or self-interest.",
    urduMeaning: "دستبرداری / انکارِ ذات (Dastbardari / Inkar-e-zaat)",
    synonyms: ["renunciation", "self-denial", "abjuration", "surrender"],
    antonyms: ["indulgence", "assertion", "acceptance", "retention"],
    example: "His sudden abnegation of the prestigious CSS seat surprised his family and peers.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    id: "vocab-11",
    word: "Alacrity",
    meaning: "Brisk and cheerful readiness, eagerness, or willingness.",
    urduMeaning: "تیزی / شوق و مستعدی (Tezi / Shauq-o-mustaidi)",
    synonyms: ["eagerness", "enthusiasm", "promptness", "readiness"],
    antonyms: ["apathy", "sluggishness", "indifference", "lethargy"],
    example: "The newly selected police sub-inspectors accepted their field assignments with great alacrity.",
    isBookmarked: false,
    category: "KPPSC Vocab"
  },
  {
    id: "vocab-12",
    word: "Anomalous",
    meaning: "Deviating from what is standard, normal, or expected.",
    urduMeaning: "خلاف معمول / بے قاعدہ (Khilaf-e-mamool / Be-qaida)",
    synonyms: ["atypical", "irregular", "unusual", "peculiar"],
    antonyms: ["normal", "typical", "regular", "standard"],
    example: "The computer operator flagged an anomalous spike in system login attempts during the late hours.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    id: "vocab-13",
    word: "Assiduous",
    meaning: "Showing great care, attention, and persistent effort.",
    urduMeaning: "محنتی / مستقل مزاج (Mehnat-kash / Mustaqil-mizaj)",
    synonyms: ["diligent", "meticulous", "industrious", "painstaking"],
    antonyms: ["lazy", "negligent", "careless", "indolent"],
    example: "Only an assiduous student can cover the massive syllabus of CSS current affairs in six months.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "جنگجو / لڑاکا (Jang-joo / Laraka)",
    synonyms: ["hostile", "belligerent", "pugnacious", "combative"],
    antonyms: ["peaceable", "amicable", "pacific", "dovish"],
    example: "The bellicose rhetoric between the political rivals escalated just days before the provincial elections.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "شور و غوغا / بے سری آواز (Shor-o-ghogha / Besuri awaz)",
    synonyms: ["din", "racket", "discordance", "harshness"],
    antonyms: ["harmony", "euphony", "silence", "melody"],
    example: "The cacophony in the public testing hall made it difficult for candidates to focus on math problems.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    id: "vocab-16",
    word: "Clemency",
    meaning: "Mercy, leniency, or mildness in executing judgment.",
    urduMeaning: "رحم دلی / نرمی (Rehm-dili / Narmi)",
    synonyms: ["leniency", "mercy", "mildness", "compassion"],
    antonyms: ["severity", "ruthlessness", "cruelty", "strictness"],
    example: "The governor rejected the appeal for clemency filed by the convict under the local security laws.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "معقول / مدلل / اثر انگیز (Maqool / Mudallal / Asar-angeez)",
    synonyms: ["compelling", "convincing", "logical", "persuasive"],
    antonyms: ["weak", "unconvincing", "invalid", "illogical"],
    example: "She presented a cogent defense of the economic reforms in her KPPSC interview.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "معمہ / پہیلی (Muamma / Paheli)",
    synonyms: ["riddle", "puzzle", "dilemma", "quandary"],
    antonyms: ["solution", "resolution", "clarity"],
    example: "Managing high inflation while maintaining growth is a chronic conundrum for Pakistani policy makers.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    ...
    urduMeaning: "کمی / قحط / قلت (Kami / Qahat / Qillat)",
    synonyms: ["scarcity", "shortage", "deficiency", "paucity"],
    antonyms: ["abundance", "surfeit", "plenty", "excess"],
    example: "A dearth of qualified IT professionals in public departments has delayed the digitization project.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "شائستگی / آداب و وقار (Shaistagi / Aadab-o-waqar)",
    synonyms: ["propriety", "decency", "politeness", "correctness"],
    antonyms: ["impropriety", "indecency", "rudeness", "solecism"],
    example: "Candidates are strictly instructed to maintain decorum and peace inside the exam centers.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    id: "vocab-21",
    word: "Ebullient",
    meaning: "Cheerful, full of energy, and exuberant.",
    urduMeaning: "جوشیلہ / پرجوش (Josheela / Pur-josh)",
    synonyms: ["exuberant", "buoyant", "joyful", "animated"],
    antonyms: ["depressed", "apathetic", "gloomy", "lethargic"],
    example: "The aspirants were in an ebullient mood after seeing that the GK paper was relatively straightforward.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    id: "vocab-22",
    word: "Enervate",
    meaning: "Make (someone) feel drained of energy or vitality; weaken.",
    urduMeaning: "کمزور کرنا / نڈھال کرنا (Kamzor karna / Nidhal karna)",
    synonyms: ["exhaust", "fatigue", "weaken", "devitalize"],
    antonyms: ["energize", "invigorate", "strengthen", "refresh"],
    example: "The hot and humid weather during the three-hour ETEA exam threatened to enervate the applicants.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    id: "vocab-23",
    word: "Equivocal",
    meaning: "Open to more than one interpretation; ambiguous or uncertain.",
    urduMeaning: "گول مول / مبہم (Gool mool / Mubham)",
    synonyms: ["ambiguous", "vague", "evasive", "indeterminate"],
    antonyms: ["clear", "unequivocal", "plain", "explicit"],
    example: "The commission gave an equivocal response regarding the final date of the screening tests.",
    isBookmarked: false,
    category: "KPPSC Vocab"
  },
  {
    ...
    urduMeaning: "پوشیدہ / رمزآمیز / خفیہ (Poshida / Ramz-ameez)",
    synonyms: ["obscure", "mysterious", "arcane", "recondite"],
    antonyms: ["public", "commonplace", "familiar", "manifest"],
    example: "The paper included esoteric questions about ancient regional treaties that few students had prepared.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "بری کرنا / بے گناہ ٹھہرانا (Bari karna / Begunah thehrana)",
    synonyms: ["exonerate", "absolve", "acquit", "vindicate"],
    antonyms: ["incriminate", "convict", "condemn", "blame"],
    example: "The forensic report served to exculpate the junior clerk accused of administrative malpractice.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "باتونی / فضول گو (Batuni / Fuzool-go)",
    synonyms: ["talkative", "loquacious", "chatty", "verbose"],
    antonyms: ["taciturn", "quiet", "reticent", "silent"],
    example: "The invigilator warned the garrulous candidates that talking during the exam would lead to paper cancellation.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "جوشیلہ خطاب / طویل طنزیہ تقریر (Josheela khitab / Taqreer)",
    synonyms: ["diatribe", "tirade", "lecture", "exhortation"],
    antonyms: ["panegyric", "accolade", "whisper", "tribute"],
    example: "Instead of detailing the policy, the politician delivered a long harangue against the opposition.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "بت شکن / باغیانہ سوچ والا (But-shikan / Baghiyana)",
    synonyms: ["rebel", "dissident", "heretic", "nonconformist"],
    antonyms: ["conformist", "believer", "traditionalist"],
    example: "As an iconoclast, the author challenged traditional methods of civil service preparation in Pakistan.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    id: "vocab-29",
    word: "Implacable",
    meaning: "Unable to be appeased, pacified, or stopped.",
    urduMeaning: "سخت گیر / سنگدل / جو راضی نہ ہو (Sakht-geer / Sangdil)",
    synonyms: ["relentless", "unyielding", "inexorable", "unappeasable"],
    antonyms: ["appeasable", "merciful", "yielding", "forgiving"],
    example: "The department showed implacable opposition to any extension of the recruitment age limit.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "ابتدائی / شروع ہونے والا (Ibtidai / Shuru-ati)",
    synonyms: ["emerging", "beginning", "nascent", "developing"],
    antonyms: ["mature", "developed", "full-blown", "dying"],
    example: "The medical team successfully arrested the incipient outbreak of dengue in the district.",
    isBookmarked: false,
    category: "KPPSC Vocab"
  },
  {
    id: "vocab-31",
    word: "Intrepid",
    meaning: "Fearless and adventurous (often used for rhetorical effect).",
    urduMeaning: "بے خوف / نڈر / دلیر (Be-khauf / Nadar / Daler)",
    synonyms: ["fearless", "brave", "valiant", "courageous"],
    antonyms: ["cowardly", "fearful", "timid", "craven"],
    example: "The intrepid rescue workers scaled the steep mountains of Swat to rescue trapped tourists.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    id: "vocab-32",
    word: "Laconic",
    meaning: "Using very few words of a person, speech, or style of writing.",
    urduMeaning: "مختصر گو / کم سخن (Mukhtasar-go / Kam-sukhan)",
    synonyms: ["brief", "concise", "terse", "succinct"],
    antonyms: ["verbose", "wordy", "garrulous", "loquacious"],
    example: "His laconic replies in the mock interview were criticized for lacking explanation.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "جھوٹا / غیر حقیقی (Jhoota / Ghayr-haqeeqi)",
    synonyms: ["lying", "untruthful", "deceitful", "dishonest"],
    antonyms: ["truthful", "honest", "sincere", "veracious"],
    example: "The court rejected the mendacious testimony provided by the fake witness.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "شریر / بدکار / گھناؤنا (Sharir / Badkar / Ghinauna)",
    synonyms: ["wicked", "evil", "villainous", "heinous"],
    antonyms: ["noble", "virtuous", "righteous", "good"],
    example: "The Federal Investigation Agency exposed the nefarious scheme of transferring money through illegal channels.",
    isBookmarked: false,
    category: "FPSC Vocab"
  },
  {
    ...
    urduMeaning: "ضدی / ہٹ دھرم (Ziddi / Hatt-dharam)",
    synonyms: ["stubborn", "obstinate", "intractable", "inflexible"],
    antonyms: ["compliant", "amenable", "malleable", "flexible"],
    example: "Despite repeated warnings, the candidate remained obdurate and refused to hand over his mobile device.",
    isBookmarked: false,
    category: "CSS Vocab"
  },
  {
    ...
    urduMeaning: "سرایت کرنے والا / ہمہ گیر (Sarayat-kunanda / Hama-geer)",
    synonyms: ["widespread", "omnipresent", "prevalent", "rife"],
    antonyms: ["localized", "limited", "rare", "restricted"],
    example: "The pervasive influence of digital media has reshaped competitive exam preparation in Pakistan.",
    isBookmarked: false,
    category: "General Vocabulary"
  },
  {
    ...
    urduMeaning: "چاپلوس / خوشامدی (Chaploos / Khushamdi)",
    synonyms: ["flatterer", "toady", "lackey", "fawner"],
    antonyms: ["rebel", "independent", "skeptic"],
    example: "Instead of offering honest feedback, the sycophant kept praising the director's failed policy.",
    isBookmarked: false,
    category: "KPPSC Vocab"
  },
  {
    ...
    urduMeaning: "ہر جگہ موجود / ہمہ گیر (Har-jah-maujood / Hama-geer)",
    synonyms: ["omnipresent", "widespread", "universal", "pervasive"],
    antonyms: ["rare", "scarce", "uncommon", "absent"],
    example: "Smartphones have become ubiquitous among competitive exam aspirants for video lectures.",
    isBookmarked: false,
    category: "General Vocabulary"
  }
];
